...
flags.DEFINE_string(
    "train_input_file", './input/train.tf_record',
    "Input TF train example files (can be a glob or comma separated).")

flags.DEFINE_string( "dev_input_file", './input/dev.tf_record',
...
def main(_):
  ...
  num_train_steps = int(train_samples_num / FLAGS.train_batch_size * FLAGS.num_train_epochs)
  ...
  if FLAGS.do_train:
    ...
    train_input_fn = input_fn_builder(
        ...
        is_training=True)
    # tensors_to_log = {"train loss": "total_loss:0"}
    # logging_hook = tf.train.LoggingTensorHook(
    #     tensors=tensors_to_log, every_n_iter=100)
    estimator.train(input_fn=train_input_fn, hooks=[],max_steps=num_train_steps)
  ...
  if FLAGS.do_eval:
    ...
    eval_input_fn = input_fn_builder(
        ...
        max_predictions_per_seq=FLAGS.max_predictions_per_seq,
        is_training=False)
    max_eval_steps = int(dev_samples_num // FLAGS.eval_batch_size)
...
if __name__ == "__main__":
  ...
  flags.mark_flag_as_required("dev_input_file")
